...
{
    public partial class CentroAnalisis : System.Web.UI.Page
    {
        ...
        protected void TB_CentroAnalisis()
        {
            try
            {
        ...
        protected void gvCentroAnalisis_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("SP_AG_FNC00409", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                ...
                cmd.Parameters.Add("@CentroAnalisis", System.Data.SqlDbType.VarChar).Value = txtCentroAnalisis.Text;
                cmd.Parameters.Add("@Id_Usuario", System.Data.SqlDbType.VarChar).Value = Session["Id_Usuario"].ToString();
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Redirect("~/Pages/AdminCombustible/CentroAnalisis.aspx");
            }
            catch (Exception)
            {
                throw;
        ...
        protected void Actualizar_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("SP_AC_FNC00409", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Id_CentroAnalisis", lbId_CentroAnalisis.Text);
                ...
                cmd.Parameters.AddWithValue("@CentroAnalisis", System.Data.SqlDbType.VarChar).Value = txCentroAnalisis.Text;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
                ModalAc(false);
        ...
        protected void gvCentroAnalisis_OnRowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ShowModalAc")
            {
                ImageButton btndetails = (ImageButton)e.CommandSource;
                GridViewRow gvrow = (GridViewRow)btndetails.NamingContainer;
                lbId_CentroAnalisis.Text = gvCentroAnalisis.DataKeys[gvrow.RowIndex].Value.ToString(); ;
                ...
                txCentroAnalisis.Text = (gvrow.FindControl("gvCentroAnalisis") as Label).Text;
                ModalAc(true);
            }
