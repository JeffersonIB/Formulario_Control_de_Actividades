                        ...
                        <ContentTemplate>
                            <asp:GridView ID="GridViewCalificaciones" runat="server" AutoGenerateColumns="False" OnRowCreated="GridViewCalificaciones_RowCreated">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Id_Lote" HeaderText="Id_Lote" />
                                    <asp:TemplateField HeaderText="Id_Lote" ItemStyle-CssClass="hidden-column">
                                        <ItemTemplate>
                                            <asp:Label ID="lblId_Lote" runat="server" Text='<%# Eval("Id_Lote") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:BoundField DataField="Id_Proceso" HeaderText="Id_Proceso" />
                                    <asp:TemplateField HeaderText="Id_Proceso" ItemStyle-CssClass="hidden-column">
                                        <ItemTemplate>
                                            <asp:Label ID="lblId_Proceso" runat="server" Text='<%# Eval("Id_Proceso") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:BoundField DataField="Actividad1" HeaderText="Actividad1" />
                                    <asp:TemplateField HeaderText="Actividad1" ItemStyle-CssClass="hidden-column">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Id_Proveedor" ItemStyle-CssClass="hidden-column">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Cantidad1" ItemStyle-CssClass="hidden-column">
                                        <ItemTemplate>
